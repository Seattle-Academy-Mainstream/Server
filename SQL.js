...
exports.AddPost = function(DataObject, Callback)
{
  ...
  FormattedObject = {Timestamp: DataObject["Timestamp"], Image: DataObject["Image"], Content: DataObject["Content"], Author: DataObject["Author"], ID: DataObject["ID"], Category: DataObject["Category"]};
...
exports.DeleteAll = function(Callback)
{
  ...
  {
    console.log(err);
    Database.query('DELETE FROM posts', function(err2, result2) 
    {
      console.log(err2);
      Callback();
    });
